                              ...
                              Expanded(
                                child: Obx(() { 
                                  return FAProgressBar(
                                    currentValue: (checkTaskController.taskModel.value.countChecked == 0) ? 0 
                                      : checkTaskController.taskModel.value.countChecked,
                                    animatedDuration :  const Duration(milliseconds: 300),
                                    direction : Axis.horizontal,
                                    borderRadius : BorderRadius.zero,
                                    backgroundColor : Colors.grey,
                                    progressColor : backColor[task1.color][1],
                                    maxValue: (checkTaskController.taskModel.value.countAll == 0) ? 100 
                                    : checkTaskController.taskModel.value.countAll,
                                    size: 5,
                                  );
                                })
                              ),
